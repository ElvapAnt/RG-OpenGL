...
void CGLDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CGLDoc::InitializeSearchContent()
{
...
void CGLDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
